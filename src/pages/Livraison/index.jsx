  ...
  return (
    <main className="contact-page">
      <section className="contact-card">
        ...
        <p className="lead">
          Nous expédions des crampons pour joueuses partout. Retrouvez ci‑dessous
          les informations principales sur les délais, les frais et le suivi.
        </p>
        ...
        <p className="lead">France: 2–5 jours. Retours possibles sous 14 jours.</p>

        <div className="actions" style={{ marginTop: 14 }}>
          <a href="/contact" className="btn">Contactez le support</a>
        </div>
      </section>
    </main>
  );
