  ...
  return (
    <main className="contact-page">
      <section className="contact-card" style={{ textAlign: "center" }}>
        ...
        <p className="lead">Oops — la page demandée n'existe pas ou a été déplacée.</p>
        ...
        <p className="status" style={{ marginTop: 14 }}>
          Retournez à <Link to="/" style={{ color: "inherit", textDecoration: "underline" }}>l'accueil</Link>.
        </p>
      </section>
    </main>
  );
